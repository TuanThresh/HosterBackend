...
namespace HosterBackend.Migrations
{
    ...
    [Migration("20250519134747_Update24")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HosterBackend.Data.Entities.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HosterBackend.Data.Entities.New", b =>
                {
                    b.HasOne("HosterBackend.Data.Entities.Category", "Category")
                        .WithMany("HasNews")
            ...
            modelBuilder.Entity("RegisteredDomain", b =>
                {
                    ...
                    b.HasOne("HosterBackend.Data.Entities.Order", "Order")
                        .WithOne("RegisteredDomain")
                        .HasForeignKey("RegisteredDomain", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
